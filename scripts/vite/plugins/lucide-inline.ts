/**
 * @fileoverview Plugin de Vite para renderizar iconos Lucide en SVG estático en index.html.
 */

import type { Plugin } from "vite";
import { renderLucideIcon } from "../lib/render-lucide-icon.ts";
...
export const lucideInlinePlugin = (): Plugin => ({
