 ...
 */
export function renderTemplateCard({ name, title, path }: DashboardTemplateCardData): string {
  return `
      <a
 ...
 */
export function renderEmptyDashboardPlaceholder(): string {
  return `
 ...
 */
export function getTemplateSizesClientScript(): string {
  return `
      <script>
