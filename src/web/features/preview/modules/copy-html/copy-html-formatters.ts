 ...
 * @returns {string}
 */
export function formatValidation(validation: ValidationResult | null | undefined): string {
 ...
 * @returns {string}
 */
export function formatLoadingMessage(build: boolean): string {
 ...
 * @returns {string}
 */
export function formatDownloadSuccessMessage(
  build: boolean,
  validation: ValidationResult | null | undefined,
): string {
  if (build) {
