...
/**
 * @typedef {Object} SafeRenderLocation
 * @property {string} path - Ruta relativa segura del archivo.
 * @property {number} [line] - Número de línea positiva entera.
 * @property {number} [column] - Número de columna positiva entera.
 */

/**
 * @typedef {Object} RenderApiErrorOptions
 * @property {number} status - Código de estado HTTP o 0 ante error de red.
 * @property {string} [code] - Código máquina del error.
 * @property {string} message - Mensaje descriptivo seguro.
 * @property {string} [cause] - Causa clasificada del error.
 * @property {SafeRenderLocation} [location] - Ubicación segura en el template.
 */
 ...
 */
export function parseSafeRenderLocation(location) {
  if (
    !location ||
